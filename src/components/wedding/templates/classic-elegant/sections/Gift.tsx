  ...
  return (
    <Section>
      ...
      <p className="mb-8 text-center text-sm leading-relaxed opacity-80">
        Doa restu Anda merupakan karunia yang sangat berarti. Jika memberi lebih, Anda dapat
        mengirim tanda kasih melalui:
      </p>
      <div className="flex flex-col gap-4">
        {gifts.map((g) => (
          ...
          >
            ...
            {g.address ? (
              <p className="mt-2 text-sm leading-relaxed whitespace-pre-line">{g.address}</p>
            ) : null}
            {g.qrImage ? (
