...
export default function ValueRail() {
  ...
  return (
    <>
      ...
      <div aria-hidden className="w-rail fixed top-0 left-0 z-20 hidden h-screen flex-col md:flex">
        {MEDIUMS.map((m) => (
      ...
      <div aria-hidden className="fixed inset-x-0 bottom-0 z-20 flex h-1.5 md:hidden">
        {MEDIUMS.map((m) => (
