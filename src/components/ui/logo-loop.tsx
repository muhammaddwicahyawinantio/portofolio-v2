...
const useAnimationLoop = (
  ...
  // Marquee ini duduk di tengah halaman panjang; tanpa gerbang ini loop-nya
  // menulis transform tiap frame sepanjang kunjungan, termasuk saat ia berada
  // ribuan piksel di luar layar.
  ...
  }, [targetVelocity, seqWidth, seqHeight, isHovered, hoverSpeed, isVertical, inView]);
};
    ...
    const rootClasses = useMemo(
      () =>
        cx(
          ...
          "[--logoloop-fadeColorAuto:var(--color-cream)]",
          "dark:[--logoloop-fadeColorAuto:var(--color-ink)]",
      ...
      (item: LogoItem, key: React.Key) => {
        if (renderItem) {
          return (
            <li
              className={cx(
                "flex-none text-[length:var(--logoloop-logoHeight)] leading-[1.05]",
        ...
        const content = nodeItem ? (
          <span
            ...
            aria-hidden={!!item.href && !nodeItem.ariaLabel}
          >
            {nodeItem.node}
          </span>
        ) : (
