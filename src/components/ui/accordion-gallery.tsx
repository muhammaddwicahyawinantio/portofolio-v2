...
type AccordionGalleryProps = {
  ...
  className?: string;
  /**
   * Dipanggil saat panel yang sudah terbuka diklik. Kalau diisi, klik tidak
   * lagi mengikuti `item.link` — pemanggil yang menentukan apa yang terjadi
   * (di sini: mengambil detail proyek lewat AJAX).
   */
...
export default function AccordionGallery({
  ...
  return (
    <div
      ref={rootRef}
      className={cn("accordion-gallery", vertical && "accordion-gallery--vertical", className)}
      style={
        {
    ...
    >
      {items.map((item, i) => {
        const isActive = i === active;
        // Elemen dinamis: <a> kalau ada link, <div> kalau tidak. Cast supaya
        // props anchor tetap ketat di mata TypeScript.
