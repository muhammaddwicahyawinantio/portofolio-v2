...
export default function Emblem({ className }: { className?: string }) {
  return (
    <span
      className={clsx("flex shrink-0 items-center justify-center rounded-full bg-white", className)}
    >
      {/* Ukuran relatif, jadi proporsinya ikut berapa pun diameter lingkarannya. */}
      <svg viewBox="0 0 18 18" className="h-[56%] w-[56%]" fill="#000000" aria-hidden>
